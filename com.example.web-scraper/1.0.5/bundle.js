...
// @version       1.0.5
// @author        Anbao Team
// @description   一个功能强大的搜狗搜索测试脚本，支持自定义输出目录、截图功能、通知功能和人工介入。
...
async function run({ page, context }) {
  ...
  try {
    ...
    let searchBox = null;
    try {
      searchBox = await page.waitForSelector("#query", { timeout: 5e3 });
    ...
    if (!hasRequestedHumanIntervention) {
      if (searchBox === null) {
        try {
          searchBox = await page.waitForSelector("#query", { timeout: 5e3 });
          context.log("\u4EBA\u5DE5\u4ECB\u5165\u540E\u91CD\u65B0\u627E\u5230\u641C\u7D22\u6846", "success");
        } catch (error) {
